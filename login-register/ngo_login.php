...
{
    header("location: ngo_welcome.php");
    exit;
}
...
if(empty($err))
{
    $sql = "SELECT id, username, password FROM ngo WHERE username = ?";
...
<html lang="en">
  ...
  <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="ngo_reg.php">Register</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="ngo_login.php">Login</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="ngo_logout.php">Logout</a>
      </li>
